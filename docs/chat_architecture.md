...
- Both tools stay advertised on every iteration; nothing disables them mid-turn. Only `MAX_TOOL_ITERATIONS` (3) bounds the loop, after which the synthesis directive forces a prose answer.
