...
# Facet writers (digest path + manual-edit path) — both target the
# ``sources`` table's facet columns (``series_name``, ``sequence_number``,
# ``season_number``) and have deliberately different semantics:
#
