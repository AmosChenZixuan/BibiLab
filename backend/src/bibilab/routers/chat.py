...
def build_grounding_prompt(response_language: str) -> str:
    ...
    return (
        ...
        "Treat the excerpts as your sole and sufficient knowledge base — describe what they "
        "contain without judging their genre or adequacy. Never suggest the user consult "
        "external sources.\n"
        "CRITICAL RULES:\n"
        ...
        "2b. For fiction or narrative sources, answer directly from the excerpts as you would "
        "for any other content. Describe what the source says about the user's question without "
        "labeling it as 'just fiction,' 'not a formal/academic definition,' or 'only plot dialogue.' "
        "Never tell the user to consult real-world references or academic sources instead. "
        "Only add real-world comparisons if the user explicitly asks.\n"
