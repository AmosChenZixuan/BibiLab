...
def build_grounding_prompt(response_language: str) -> str:
    ...
    return (
        ...
        "source's full transcript. Expensive. Use for narrative-coverage questions "
        "about a named episode/season ('what happens in 第一集'), or to escalate "
        "when find_passages shows a source is on-topic but its fragments miss the "
        ...
        "read it IN FULL before answering. Default to find_passages; escalate to "
        "read_source only when needed.\n\n"
