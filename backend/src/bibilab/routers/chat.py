...
def build_grounding_prompt(response_language: str) -> str:
    ...
    return (
        ...
        "2b. If the source material is fiction, narrative, or storytelling, treat its content "
        "as self-contained. Answer using only what the retrieved excerpts say — do not compare "
        "fictional content to the real world or add external commentary. Do not refuse to answer "
        "just because the material is fiction. Only introduce real-world context if the user "
