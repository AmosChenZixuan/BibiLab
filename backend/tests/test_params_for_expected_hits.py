...
class TestParamsForExpectedHits:
    def test_one(self):
        ...
        assert p == RetrievalParams(depth_per_source=1, top_k=2, expected_hits="one")
    ...
    def test_few(self):
        ...
        assert p == RetrievalParams(depth_per_source=2, top_k=8, expected_hits="few")
    ...
    def test_many(self):
        ...
        assert p == RetrievalParams(depth_per_source=5, top_k=24, expected_hits="many")
