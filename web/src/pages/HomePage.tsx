...
export function HomePage() {
  ...
  return (
    <div className="grid gap-4">
      ...
      >
        <div className="rounded-2xl border border-pink/50 bg-pink/10 p-4 text-caption text-pink">
          <p className="m-0 text-body font-semibold tracking-tight">{t("home.cannotUndo")}</p>
          <p className="mt-1.5 mb-0 text-body leading-6">
            {deleteTarget
