...
describe("Artifact types", () => {
  test("ArtifactStatus is union of generating, completed, failed", () => {
    const statuses: ArtifactStatus[] = ["generating", "completed", "failed"];
  ...
  test("Artifact can have error field when status is failed", () => {
    const artifact: Artifact = {
      id: "artifact-2",
